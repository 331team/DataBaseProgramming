...
String mySQL = "select * from teach where p_id = '" + p_id + "' and t_year = " + year + " and t_semester = " + semester;
...
<%
	...
	while(myResultSet.next() != false){
		String c_id="", c_id_no="", c_name="", t_day="", t_startTime="", t_endTime="", t_where="", p_name="";
		int c_unit=0;
